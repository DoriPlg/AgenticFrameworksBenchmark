...
def patched_init(self, *args, client: OvhClient = None, **kwargs):
    """Replace the model with OvhClient if not provided."""
    original_init(self, *args, **kwargs)
    self.client = client
    print("Agent created with OvhClient model")
...
def run(self, message, conversation_id=None):
    ...
    try:
        ...
        # Get a response directly from the model (OvhClient)
